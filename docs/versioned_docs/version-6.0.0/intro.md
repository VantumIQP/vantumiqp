...
<picture width="500">
  <source
    ...
    alt="VantumIQP logo (dark)"
  />
  <img
    width="600"
    src="/img/vantumiqp-logo.png"
    alt="VantumIQP logo (light)"
  />
</picture>
...
[**Resources**](#resources) |
[**Organizations Using VantumIQP**](https://github.com/apache/superset/blob/master/RESOURCES/INTHEWILD.md)
...
VantumIQP can query data from any SQL-speaking datastore or data engine (Presto, Trino, Athena, [and more](https://superset.apache.org/docs/configuration/databases)) that has a Python DB-API driver and a SQLAlchemy dialect.
...
- [VantumIQP "In the Wild"](https://github.com/apache/superset/blob/master/RESOURCES/INTHEWILD.md) - open a PR to add your org to the list!
- [Feature Flags](/docs/6.0.0/configuration/feature-flags) - the status of VantumIQP's Feature Flags.
