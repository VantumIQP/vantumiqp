...
<p>
  <img
    width="180"
    src="vantumiqp_brand_assets/vantumiqp_logo.png"
    alt="VantumIQP logo"
  />
</p>
...
- **[Administrator Guide](https://superset.apache.org/admin-docs/)** — Install, configure, and operate VantumIQP. Covers security, scaling, and database drivers.
- **[Developer Guide](https://superset.apache.org/developer-docs/)** — Contribute to VantumIQP or build on its REST API and extension framework.

[**Why VantumIQP?**](#why-vantumiqp) |
...
[**Resources**](#resources) |
[**Organizations Using VantumIQP**](https://superset.apache.org/inTheWild)

## Why VantumIQP?

VantumIQP is a modern data exploration and data visualization platform. VantumIQP can replace or augment proprietary business intelligence tools for many teams. VantumIQP integrates well with a variety of data sources.
...
VantumIQP can query data from any SQL-speaking datastore or data engine (Presto, Trino, Athena, [and more](https://superset.apache.org/docs/databases)) that has a Python DB-API driver and a SQLAlchemy dialect.
...
<p align="center">
  ...
  <a href="https://superset.apache.org/docs/databases/supported/superset-meta-database" title="VantumIQP meta database"><img src="docs/static/img/databases/superset.svg" alt="VantumIQP meta database" width="150" height="39" /></a> &nbsp;
...
Try out VantumIQP's [quickstart](https://superset.apache.org/docs/quickstart/) guide or learn about [the options for production deployments](https://superset.apache.org/docs/installation/architecture/).
...
- If you want to help troubleshoot GitHub Issues involving the numerous database drivers that VantumIQP supports, please consider adding your name and the databases you have access to on the [VantumIQP Database Familiarity Rolodex](https://docs.google.com/spreadsheets/d/1U1qxiLvOX0kBTUGME1AHHi6Ywel6ECF8xk_Qy-V9R8c/edit#gid=0)
- Join VantumIQP's Town Hall and [Operational Model](https://preset.io/blog/the-superset-operational-model-wants-you/) recurring meetings. Meeting info is available on the [VantumIQP Community Calendar](https://superset.apache.org/community)
...
- [VantumIQP "In the Wild"](https://superset.apache.org/inTheWild) - see who's using VantumIQP, and [add your organization](https://github.com/apache/superset/edit/master/RESOURCES/INTHEWILD.yaml) to the list!
- [Feature Flags](https://superset.apache.org/docs/configuration/feature-flags) - the status of VantumIQP's Feature Flags.
- [Standard Roles](https://github.com/apache/superset/blob/master/RESOURCES/STANDARD_ROLES.md) - How RBAC permissions map to roles.
- [VantumIQP Wiki](https://github.com/apache/superset/wiki) - Tons of additional community resources: best practices, community content and other information.
- [VantumIQP SIPs](https://github.com/orgs/apache/projects/170) - The status of VantumIQP's SIPs (VantumIQP Improvement Proposals) for both consensus and implementation status.

Understanding the VantumIQP Points of View

- [The Case for Dataset-Centric Visualization](https://preset.io/blog/dataset-centric-visualization/)
- [Understanding the VantumIQP Semantic Layer](https://preset.io/blog/understanding-superset-semantic-layer/)

- Getting Started with VantumIQP
  - [VantumIQP in 2 Minutes using Docker Compose](https://superset.apache.org/docs/installation/docker-compose#installing-superset-locally-using-docker-compose)
  ...
  - [Comprehensive Tutorial for Contributing Code to VantumIQP
    ](https://preset.io/blog/tutorial-contributing-code-to-apache-superset/)
- [Resources to master VantumIQP by Preset](https://preset.io/resources/)
...
- Recordings of Past [VantumIQP Community Events](https://preset.io/events)

  - [Mixed Time Series Charts](https://preset.io/events/mixed-time-series-visualization-in-superset-workshop/)
  - [How the Bing Team Customized VantumIQP for the Internal Self-Serve Data & Analytics Platform](https://preset.io/events/how-the-bing-team-heavily-customized-superset-for-their-internal-data/)
  - [Live Demo: Visualizing MongoDB and Pinot Data using Trino](https://preset.io/events/2021-04-13-visualizing-mongodb-and-pinot-data-using-trino/)
  - [Introduction to the VantumIQP API](https://preset.io/events/introduction-to-the-superset-api/)
  - [Building a Database Connector for VantumIQP](https://preset.io/events/2021-02-16-building-a-database-connector-for-superset/)

- Visualizations

  - [Creating Viz Plugins](https://superset.apache.org/docs/contributing/creating-viz-plugins/)
  - [Managing and Deploying Custom Viz Plugins](https://medium.com/nmc-techblog/apache-superset-manage-custom-viz-plugins-in-production-9fde1a708e55)
  - [Why VantumIQP is Betting on Apache ECharts](https://preset.io/blog/2021-4-1-why-echarts/)

- [VantumIQP API](https://superset.apache.org/docs/rest-api)
